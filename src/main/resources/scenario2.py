...
clip1a = VideoFileClip("first_clip.mp4").subclipped(10, 30).with_start(AUTO_GENERATED_CLIP_0.end)
...
AUTO_GENERATED_CLIP_3 = TextClip(text="s3", font=font, font_size=48, color='white').with_start(clip1b.start + 5).with_duration(15)
