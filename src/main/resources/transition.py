...
clip1a = VideoFileClip("first_clip.mp4").subclipped(10, 25).with_start(10)
clip1a = clip1a.with_effects([vfx.FadeIn(2.0)])
clip1a = clip1a.with_effects([vfx.FadeOut(2.0)])
...
caption4 = (TextClip(text="s3", font=font, font_size=48, color='white').with_duration(35).with_position('center').with_start(caption3.start-5 + 0))
